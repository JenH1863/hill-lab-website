        ...
        <div className="mt-6 grid gap-6 md:grid-cols-2">
          <div className="rounded-lg border border-gray-200 p-6 dark:border-gray-700">
            ...
            <p className="mt-2 text-sm leading-6 text-gray-600 dark:text-gray-300">
              ...
              homeostasis using rodent models and circuit-level manipulations.
            </p>
            <div className="mt-3">
              <Link
          ...
          <div className="rounded-lg border border-gray-200 p-6 dark:border-gray-700">
            ...
            <p className="mt-2 text-sm leading-6 text-gray-600 dark:text-gray-300">
              We investigate mechanisms linking metabolic dysfunction and endocrine signaling to adverse cardiometabolic
              outcomes in PCOS and pregnancy.
            </p>
            <div className="mt-3">
              <Link
                className="text-primary-500 hover:text-primary-600 dark:hover:text-primary-400"
          ...
          <div className="rounded-lg border border-gray-200 p-6 dark:border-gray-700">
            ...
            <p className="mt-2 text-sm leading-6 text-gray-600 dark:text-gray-300">
              We study how glial insulin signaling shapes neuroendocrine outputs that control metabolism and reproductive
              health.
            </p>
            <div className="mt-3">
              <Link
