...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    ...
    >
      <link rel="icon" type="image/png" href={`${basePath}/static/favicons/favicon-96x96.png`} sizes="96x96" />
      ...
      <meta name="apple-mobile-web-app-title" content="Backend Engineer Road" />
